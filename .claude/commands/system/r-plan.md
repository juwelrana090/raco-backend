...
Plan the requested feature: 4. Read full memory system (if cache is cold) 5. Read all relevant .claude/modules/ files 6. List all files to create/change/delete 7. List patterns to follow 8. List rules that apply 9. Map blast radius 10. List risks and gotchas 11. Write step by step execution order
