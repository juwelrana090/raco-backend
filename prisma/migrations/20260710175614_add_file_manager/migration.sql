...
-- CreateIndex
CREATE INDEX "Product_file_manager_id_idx" ON "Product"("file_manager_id");
...
-- AddForeignKey
ALTER TABLE "Product" ADD CONSTRAINT "Product_file_manager_id_fkey" FOREIGN KEY ("file_manager_id") REFERENCES "file_manager"("id") ON DELETE SET NULL ON UPDATE CASCADE;
